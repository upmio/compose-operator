...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisReplicaNode) DeepCopyInto(out *RedisReplicaNode) {
	*out = *in
	out.RedisNode = in.RedisNode
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisReplicaNode.
func (in *RedisReplicaNode) DeepCopy() *RedisReplicaNode {
	if in == nil {
		return nil
	}
	out := new(RedisReplicaNode)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in RedisReplicaNodes) DeepCopyInto(out *RedisReplicaNodes) {
	{
		in := &in
		*out = make(RedisReplicaNodes, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(RedisReplicaNode)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisReplicaNodes.
func (in RedisReplicaNodes) DeepCopy() RedisReplicaNodes {
	if in == nil {
		return nil
	}
	out := new(RedisReplicaNodes)
	in.DeepCopyInto(out)
	return *out
}
