...
import (
	...
	"github.com/upmio/compose-operator/controller"
	composerwebhook "github.com/upmio/compose-operator/webhook"
...
func init() {
	...
	utilruntime.Must(composev1alpha1.AddToScheme(scheme))
